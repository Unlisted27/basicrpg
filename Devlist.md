Where things go to be developed
...
-  Weapon slot  
    ...
    ~~- Roll function for weapon objects.~~  
    ~~- Attack references whatever is in this slot to add damage~~  
    - If strength is too low, heavy weapons cannot be carried   

### Combat  
~~-  Attack feature needs to reference character stats and equiped item to figure out total damage~~  
~~-  Weapons have proper damage capabilities (hit dice and base damage on hit)~~  
- Critical hit: Nat 20 roll to hit gives 2x attack dice
