...
class races():
    ...
    elf = components.race("Elf",0,0,0,1)
class professions():
...
class items():
    class weapons():
        ...
        long_sword = item.weapon("Long sword",4,"A long, gleaming shaft",(1,8),+2)
    class foods():
        apple = item.food("Apple",0.05,"A juicy red apple",1)
...
class characters():
    ...
    gnarwl = components.character(races.goblin,professions.commoner,"Gnarwl")#Sane as top, but race is set as goblin